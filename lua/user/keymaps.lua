...
M.map_lsp_keybinds = function(buffer_number)
  ...
  inoremap("<C-k>", vim.lsp.buf.hover, { desc = "LSP: Signature Documentation", buffer = buffer_number })
  nnoremap("<C-k>", vim.lsp.buf.hover, { desc = "LSP: Signature Documentation", buffer = buffer_number })
